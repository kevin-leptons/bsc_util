...
const BI_FACTORY_ADDRESS = Buffer.from(
    '858e3312ed3a876947ea49d572a7c42de08af7ee',
    'hex'
)
const BI_FACTORY_INIT_CODE = Buffer.from(
...
const CAFE_FACTORY_ADDRESS = Buffer.from(
    '3e708fdbe3ada63fc94f8f61811196f1302137ad',
    'hex'
)
const CAFE_FACTORY_INIT_CODE = Buffer.from(
    '90bcdb5d0bf0e8db3852b0b7d7e05cc8f7c6eb6d511213c5ba02d1d1dbeda8d3',
    'hex'
)
const JET_FACTORY_ADDRESS = Buffer.from(
    '0eb58E5c8aA63314ff5547289185cC4583DfCBD5',
    'hex'
)
const JET_FACTORY_INIT_CODE = Buffer.from(
    '3125d0a15fa7af49ce234ba1cf5f931bad0504242e0e1ee9fcd7d1d7aa88c651',
    'hex'
)
...
// Descriptions
//  * Build PancakeSwap V1 pool address address.
//
// Input
//  * addressA {EthAddress} ETH token address.
...
// Descriptions
//  * Build PancakeSwap V2 pool address.
//  * Factory source: See section `References` in `doc/readme.md`.
//
// Input
...
// Descriptions
//  * Build JustLiquidity pool address.
//  * JustLiquidity pool is use by JulSwap.
//  * Factory source: See section `References` in `doc/readme.md`.
//
// Input
//  * addressA {EthAddress} ETH token address.
...
// Descriptions
//  * Build Ape pool address.
//  * Ape pool is use by ApleSwapFinance.
//  * Factory source: See section `References` in `doc/readme.md`.
//
// Input
//  * addressA {EthAddress} ETH token address.
...
// Descriptions
//  * Build Demax pool address.
//  * Demax pool is use by BurgerSwap.
//  * Factory source: See section `References` in `doc/readme.md`.
//
// Input
//  * addressA {EthAddress} ETH token address.
...
// Descriptions
//  * Build Bi pool address.
//  * Bi pool address is created by the same way as Pancake but with
...
// Descriptions
//  * Build Cafe pool address.
//  * Cafe pool address is created by the same way as Pancake but with
//    different factory address and init code.
//  * Factory source: See section `References` in `doc/readme.md`.
//
// Input
...
// Descriptions
//  * Build Jet pool address.
//  * Jet pool address is created by the same way as Pancake but with
//    different factory address and init code.
//  * Factory source: See section `References` in `doc/readme.md`.
//
// Input
